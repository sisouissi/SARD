...
export const Stethoscope: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M4.8 2.3A.3.3 0 1 0 5 2a3.4 3.4 0 0 1 5 5L12 9l-1.4 1.4"></path>
    <path d="M9 12H4a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h5"></path>
    <path d="M19.2 2.3a.3.3 0 1 1-.2.2 3.4 3.4 0 0 1-5 5L12 9l1.4 1.4"></path>
    <path d="M15 12h5a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-5"></path>
    <path d="M12 9v12"></path><circle cx="12" cy="21" r="1"></circle>
  </svg>
);
...
export const Calculator: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <g fill="currentColor"><circle cx="8" cy="10" r="1"></circle><circle cx="12" cy="10" r="1"></circle><circle cx="16" cy="10" r="1"></circle><circle cx="8" cy="14" r="1"></circle><circle cx="12" cy="14" r="1"></circle><circle cx="8" cy="18" r="1"></circle><circle cx="12" cy="18" r="1"></circle></g>
  </svg>
);
